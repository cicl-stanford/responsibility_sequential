...
############ PARAMS ############
human_scaler=2.0    # controls the stochasticity in the movements of the human agent
ai_scaler=2.0       # controls the stochasticity in the movements of the ai agent
sim_scaler=2.0      # controls the stochaticity in the internal simulation of the human agent
agent_seeds=20      # run 20 counterfactual simulations
